...
# Charger les images
player_image = pygame.image.load(r"img/player.png").convert_alpha()
sword_image = pygame.image.load(r"img/epee-de-legende.png").convert_alpha()
shield_image = pygame.image.load(r"img/bouclier-d'hilya.png").convert_alpha()
health_item_image = pygame.image.load(r"img/objets-de-soin.png").convert_alpha()
enemy_image = pygame.image.load(r"img/enemy.png").convert_alpha()
...
player_walk_right = [
    pygame.image.load(r"img/walk_right_1.png").convert_alpha(),
    pygame.image.load(r"img/walk_right_2.png").convert_alpha(),
    pygame.image.load(r"img/walk_right_3.png").convert_alpha(),
    pygame.image.load(r"img/walk_right_4.png").convert_alpha()
]

player_walk_left = [
    pygame.image.load(r"img/walk_left_1.png").convert_alpha(),
    pygame.image.load(r"img/walk_left_2.png").convert_alpha(),
    pygame.image.load(r"img/walk_left_3.png").convert_alpha(),
    pygame.image.load(r"img/walk_left_4.png").convert_alpha()
]
...
class Sword:
    ...
    def attack_normal(self, player_x, player_y):
        ...
        for enemy in enemies[:]:
            ...
            if distance_to_enemy < 50:  # Rayon de 10 pixels pour l'attaque normale
    ...
    def attack_charged(self, player_x, player_y):
        ...
        if self.is_charging:
            ...
            if charge_time >= 2:  # Si l'attaque a été chargée pendant au moins 2 secondes
                for enemy in enemies[:]:
                    distance_to_enemy = math.sqrt((player_x - enemy.x)**2 + (player_y - enemy.y)**2)
                    if distance_to_enemy < 100:  # Rayon de 50 pixels pour l'attaque chargée
...
def draw_health_bar(win, health):
    pygame.draw.rect(win, RED, (10, 10, 500, 20))  # Barre de fond rouge
